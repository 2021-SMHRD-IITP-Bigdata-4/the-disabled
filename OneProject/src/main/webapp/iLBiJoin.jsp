...
<link rel="stylesheet" href="iLBiJoin.css" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-0b40"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="carousel_637d">
            ...
            <div class="u-layout-row">
              <div class="u-align-center u-container-style u-layout-cell u-right-cell u-size-60 u-layout-cell-1">
                <div class="u-container-layout u-valign-top u-container-layout-1">
                  <h2 class="u-text u-text-default u-text-1">회원가<span style="font-weight: 700;"></span>입
                  </h2>
                  <div class="u-form u-form-1">
                    <form action="JoinService" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-15 u-form-vertical u-inner-form" style="padding: 0;" source="custom" name="form" redirect="true">
                      ...
                      <div class="u-form-group u-form-group-3">
                        ...
                        <input type="text" placeholder="비밀번호를 입력하시오." id="text-4b1b" name="pwcheck" class="u-border-1 u-border-grey-40 u-input u-input-rectangle u-white">
                      </div>
                      <div class="u-form-group u-form-group-4">
                        <label for="text-e67b" class="u-label">닉네임</label>
                        <input type="text" placeholder="닉네임을 입력하시오." id="text-e67b" name="nick" class="u-border-1 u-border-grey-40 u-input u-input-rectangle u-white">
                      </div>
                      ...
                      <div class="u-align-center u-form-group u-form-submit">
                        <a href="#" class="u-active-palette-1-light-2 u-border-none u-btn u-btn-round u-btn-submit u-button-style u-custom-color-1 u-hover-palette-4-base u-radius-12 u-btn-1">회원가입</a>
